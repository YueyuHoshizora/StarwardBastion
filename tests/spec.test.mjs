...
test('12 種塔數值符合唯一有效塔表，T05 射程 3.0／偵測 6.0，無 T13', () => {
  ...
  assert.deepEqual(
    ...
    [[120, 'ground', 3.5, 9, 0.6], [230, 'ground', 5.0, 42, 1.8], [280, 'ground', 4.0, 48, 2.4], [300, 'ground', 4.5, 15, 0.5],
      [220, 'ground', 3.0, 4, 1.0], [290, 'ground', 3.8, 24, 1.2], [150, 'air', 5.5, 30, 1.2], [260, 'air', 4.8, 48, 1.8],
      [330, 'air', 4.0, 44, 2.2], [310, 'both', 3.8, 8, 0.5], [340, 'both', 3.2, 6, 1.0], [360, 'both', 4.5, 18, 1.0]],
  );
});
