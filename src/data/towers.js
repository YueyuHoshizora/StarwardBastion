...
export const TOWERS = [
  { id: 'T01', name: '脈衝機砲', cost: 120, target: 'ground', range: 3.5, damage: 11, interval: 0.6, attack: 'bullet', ignoreShield: true,
    effect: '單體 18.3 DPS；無視護盾，直接扣 HP', silhouette: '圓形底座、中央單管炮口、炮管朝向目標旋轉' },
  { id: 'T02', name: '軌道穿透炮', cost: 250, target: 'ground', range: 5.0, damage: 38, interval: 1.8, attack: 'pierce', pierce: 3,
    effect: '直線最多命中 3 名，每名完整傷害', silhouette: '長矩形炮身、中央亮線、兩端對稱磁軌' },
  { id: 'T03', name: '等離子迫擊塔', cost: 280, target: 'ground', range: 4.0, damage: 64, interval: 2.4, attack: 'mortar', splash: 1.2,
  ...
  { id: 'T06', name: '電弧跳躍塔', cost: 290, target: 'ground', range: 3.8, damage: 32, interval: 1.2, attack: 'chain', jumps: 2, jumpFalloff: 0.7, jumpRange: 2.4,
    effect: '主目標加最多 2 次跳躍；每跳傷害乘 0.7；跳距 2.4 格', silhouette: '三個不等距電極環繞中央核心，呈三叉形' },
  { id: 'T07', name: '防空追蹤塔', cost: 170, target: 'air', range: 5.5, damage: 30, interval: 1.2, attack: 'missile',
    effect: '單體追蹤，25 DPS', silhouette: '四角十字底座、中央雷達盤、四枚飛彈艙' },
  { id: 'T08', name: '高射線圈炮', cost: 230, target: 'air', range: 4.8, damage: 48, interval: 1.8, attack: 'pierce', pierce: 3,
    effect: '直線最多命中 3 名，每名完整傷害', silhouette: '雙平行線圈、長方形炮口、兩側對稱線圈標記' },
  { id: 'T09', name: '天穹光束陣列', cost: 250, target: 'air', range: 4.0, damage: 64, interval: 2.0, attack: 'burst', splash: 1.2,
    effect: '爆炸半徑 1.2 格，範圍每名完整傷害', silhouette: '四個外置發光節點包圍空心方形中心' },
  { id: 'T10', name: '蜂群無人機巢', cost: 310, target: 'both', range: 3.8, damage: 7, interval: 0.5, attack: 'drones', drones: 2,
    effect: '2 架無人機，最多攻擊 2 目標；各機 14 DPS、同目標合計 28 DPS', silhouette: '中央六角巢艙、六個環狀停泊孔、外圈六片短翼' },
  { id: 'T11', name: '重力井發生器', cost: 260, target: 'both', range: 3.2, damage: 12, interval: 1.0, attack: 'gravity', splash: 1.6, slow: 0.3, slowDuration: 1.5,
