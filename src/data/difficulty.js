...
export const DIFFICULTY = {
  1: { star: 1, hpPct: 200, speedPct: 100, buildPct: 55, maxTypes: 2 },
  2: { star: 2, hpPct: 225, speedPct: 105, buildPct: 50, maxTypes: 3 },
  3: { star: 3, hpPct: 250, speedPct: 110, buildPct: 45, maxTypes: 4 },
  4: { star: 4, hpPct: 275, speedPct: 115, buildPct: 40, maxTypes: 5 },
  5: { star: 5, hpPct: 300, speedPct: 120, buildPct: 35, maxTypes: 6 },
};
...
/**
 * round_half_up(base × 星級倍率 × 關卡調校 × W(n))，全程整數運算。
 * tunePct：地圖的關卡 HP 調校（百分比，預設 100），修正同星級地圖因地形造成的難度差異。
 */
export function scaledHp(base, star, n, tunePct = 100) {
  if (base === 0) return 0;
  const num = base * DIFFICULTY[star].hpPct * tunePct * waveMultPct(n);
  return Math.floor((num + 500000) / 1000000);
}
