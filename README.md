...
- 資料附錄：
  ...
  - [波次](docs/附錄B_波次編成.md)
  - [音樂](docs/附錄C_音樂音序.md)
- 數值總表：[`DESIGN.md`](DESIGN.md)；平衡分析：[平衡測試報告](docs/平衡測試報告.md)。報告以高手、一般（初見）、新手三種玩家模型掃描每張地圖，並做敵人 HP 壓力測試。目標是星級越高越難（初見一般玩家勝率 1★ 約 97%、5★ 約 32%），同時每張地圖的高手都至少有 5 種通關方式，最佳配置能保住 80% 基地生命。
